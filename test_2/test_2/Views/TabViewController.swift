...
class TabViewController: UITabBarController {
    override func viewDidLoad() {
        ...
        mainViewController.tabBarItem = UITabBarItem(title: NSLocalizedString("VPN", comment: "VPN"), image: vpnTab.withRenderingMode(.alwaysOriginal),
        ...
        serversListViewController.tabBarItem = UITabBarItem(title: NSLocalizedString("servers", comment: "Servers"), image: serverListTab.withRenderingMode(.alwaysOriginal),
        ...
        settingsViewController.tabBarItem = UITabBarItem(title: NSLocalizedString("settings", comment: "Settings"), image: settingsTab.withRenderingMode(.alwaysOriginal),
